...
public class HexagonGameBoardTest {
    ...
    /**
     * Test that a new HexagonGameBoard can be created and has the expected
     * dimensions.
     */
    @Test
     ...
     * It checks the amount of boardPieces, terrains and winning pieces that are
     * created.
     */
    @Test
    ...
    public void testAddTerrain() {
        ...
        assertEquals(1, hexagonGameBoard.getAllTerrains().size(),
                "Actual count: " + hexagonGameBoard.getAllTerrains().size());
   ...
   public void testHexagonGameBoardDefaultLocation() {
       Point defaultLocation = new Point(0,0);
        ...
        assertEquals(hexagonGameBoard.getLocation(), defaultLocation,
                "Default getLocation() should return " + defaultLocation);
    }
    ...
    public void testHexagonGameBoardSetLocation() {
        ...
        assertEquals(hexagonGameBoard.getLocation(), newPoint,
                "The newly setLocation(newPoint) should have set the location to " + newPoint);
    }
    ...
    public void testHexagonGameBoardPlayer() {
        ...
        // assertEquals(hexagonGameBoard.players.get(playerId).color,
        // player.getColor());
        //
        // // Set the players position and check if it actually does set the position
        // hexagonGameBoard.players.get(playerId).setPlayerPosition(row + counter, col +
        // counter);
        //
        // assertEquals(hexagonGameBoard.players.get(playerId).getCurrentCol(), col +
        // counter);
        // assertEquals(hexagonGameBoard.players.get(playerId).getCurrentRow(), row +
        // counter);
        //
        // counter++;
        // }
        ...
        //
        // assertFalse(hexagonGameBoard.isValidPosition(0, 0));//check if player can go
        // outside the boards
        ...
        //
        // //player1 is already at 2,3 so it's not a valid position for others to come
        // here
    ...
    public void testIsValidLocation() {
        ...
        //
        // hexagonGameBoard.isValidPosition(hexagonGameBoard.players.get(0).getCurrentRow(),
        // hexagonGameBoard.players.get(0).getCurrentCol());
    }
}
