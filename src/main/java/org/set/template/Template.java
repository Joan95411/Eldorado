...
public abstract class Template extends JPanel {
    ...
    public void drawPiles(Graphics2D g2d, Map<Card, Integer> currentMarket, String caption, int[] temp,
            int maxCardsPerRow, int cardSpacing) {
    ...
    public void drawAssets(Graphics2D g2d, List<? extends Asset> assets, String caption, int[] temp,
            int maxAssetsPerRow, int assetSpacing) {
